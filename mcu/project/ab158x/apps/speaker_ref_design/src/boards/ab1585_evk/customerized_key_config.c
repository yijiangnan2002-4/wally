...
const apps_config_key_event_map_t temp_key_short_click_configs[] = {
    ...
    },
    {
        EINT_KEY_2,
        KEY_DOUBLE_PARTNER,
        (1 << APP_DISCONNECTED) | (1 << APP_CONNECTABLE) | (1 << APP_CONNECTED) | (1 << APP_A2DP_PLAYING) | (1 << APP_LE_AUDIO_BIS_PLAYING)
    },
};
...
const apps_config_key_event_map_t temp_key_long_press1_configs[] = {
#ifdef AIR_MS_TEAMS_ENABLE
    {
        ...
        (1 << APP_DISCONNECTED) | (1 << APP_CONNECTABLE) | (1 << APP_CONNECTED) | (1 << APP_A2DP_PLAYING) | (1 << APP_HFP_CALL_ACTIVE_WITHOUT_SCO)
        | (1 << APP_ULTRA_LOW_LATENCY_PLAYING) | (1 << APP_WIRED_MUSIC_PLAY) | (1 << APP_HFP_CALL_ACTIVE) | (1 << APP_STATE_HELD_ACTIVE)
    },
    {
        EINT_KEY_0,
