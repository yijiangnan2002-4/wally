...
IC_TYPE                               := ab1582p
BOARD_TYPE                            := ab1582p_evk_multi_ch_output
BL_FEATURE                            := feature_82_evb.mk
...
AIR_PRODUCT_CATEGORY = AB1585_Speaker
...
# This option is to choose dual chip battery type.
# This option is only valid when AIR_DUAL_CHIP_MIXING_MODE is not none.
# Usage: single_battery, dual_battery, none
#                         single_battery : It's single battery solution.
#                         dual_battery   : It's dual battery solution.
#                         none           : It's not dual chip project.
AIR_DUAL_CHIP_BATTERY_TYPE = none
...
##############################################
include $(SOURCE_DIR)/../dsp/project/$(BOARD)/apps/dsp0_headset_ref_design/XT-XCC/feature_82p_speaker_multi_ch.mk
