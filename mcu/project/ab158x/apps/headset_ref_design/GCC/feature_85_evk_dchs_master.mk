...
AIR_DUAL_CHIP_BATTERY_TYPE = dual_battery
...
##############################################
include $(SOURCE_DIR)/../dsp/project/$(BOARD)/apps/dsp0_headset_ref_design/XT-XCC/feature_85_evk_dchs_master.mk
