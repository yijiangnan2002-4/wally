 ...
 */
 ...
 /**
  * File: app_bolt_poc_idle_activity.h
  *
  * Description: This file defines the interface of app_bolt_poc_idle_activity.c.
  *
  * Note: todo.
  *
  */

#ifndef __APP_BOLT_POC_IDLE_ACTIVITY_H__
#define __APP_BOLT_POC_IDLE_ACTIVITY_H__
...
#include "ui_shell_al_platform_log.h"
  ...
  /**
  * @brief      This function is the interface of the app_bolt_dongle, and is only called by ui_shell when events are sent.
