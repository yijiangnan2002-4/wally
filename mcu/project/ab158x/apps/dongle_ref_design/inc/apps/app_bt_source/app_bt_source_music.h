...
#ifndef __APP_BT_SOURCE_MUSIC_H__
#define __APP_BT_SOURCE_MUSIC_H__

/**
 * File: app_bt_source_music.h
 *
 * Description: This file defines the interface of app_bt_source_music.c.
 *
 */
...
#endif /* __APP_BT_SOURCE_MUSIC_H__ */
