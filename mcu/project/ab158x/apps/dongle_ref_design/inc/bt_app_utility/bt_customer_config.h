...
#define BT_SOURCE_SRV_INVALID_VOLUME_VALUE      0xFF
...
#if AIR_BT_SOURCE_ENABLE
/**
 * @brief    This function is used to get volume value by gain.
 * @return   The mapping volume vaule, BT_SOURCE_SRV_INVALID_VOLUME_VALUE is invalid value.
 */
