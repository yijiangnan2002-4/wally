...
BT_ALIGNMENT4( static char bt_l2cap_le_cbfcm_link_cb_buf[BT_L2CAP_LE_CBFCM_LINK_BUF_SIZE]);
BT_ALIGNMENT4( static char bt_l2cap_le_ecbfcm_link_cb_buf[BT_L2CAP_LE_ECBFCM_LINK_BUF_SIZE]);
#endif
...
#ifdef AIR_BT_FAST_PAIR_LE_AUDIO_ENABLE
    bt_memory_init_control_block(BT_MEMORY_CONTROL_BLOCK_L2CAP_LE_CBFCM, bt_l2cap_le_cbfcm_link_cb_buf,  BT_L2CAP_LE_CBFCM_LINK_BUF_SIZE);
    bt_memory_init_control_block(BT_MEMORY_CONTROL_BLOCK_L2CAP_LE_ECBFCM, bt_l2cap_le_ecbfcm_link_cb_buf,  BT_L2CAP_LE_ECBFCM_LINK_BUF_SIZE);
#endif
#ifdef MTK_BT_AVRCP_BROWSE_ENABLE
...
//   uint32_t EDR_table_size = sizeof(tx_pwr_BTD_EDR_table);
        ...
        bt_firmware_type_set(BT_FIRMWARE_TYPE_SPEAKER);
#else
