...
/**
 * File: app_va_xiaoai_ota.h
 *
 * Description: This file defines the interface of XiaoAI OTA.
 *
 */

#ifndef __APP_VA_XIAOAI_OTA_H__
#define __APP_VA_XIAOAI_OTA_H__
