...
/**
 * File: app_va_xiaoai_miui_fast_connect.h
 *
 * Description: This file defines the interface of MIUI Fast Connect Feature (same account spec).
 *
 */

#ifndef __APP_VA_XIAOAI_MIUI_FAST_CONNECT_H__
#define __APP_VA_XIAOAI_MIUI_FAST_CONNECT_H__
...
#endif /* __APP_VA_XIAOAI_MIUI_FAST_CONNECT_H__ */
