...
#define AIR_BT_TAKEOVER_KEEP_DONGLE
#define AIR_BT_TAKEOVER_DONGLE_MUST_TAKEOVER
#define AIR_BT_TAKEOVER_EMP_OFF_ALWAYS_REJECT_NEW
#elif defined(AIR_BT_FAST_PAIR_SASS_ENABLE)
#define AIR_BT_TAKEOVER_EMP_OFF_ALWAYS_TAKEOVER
#endif
