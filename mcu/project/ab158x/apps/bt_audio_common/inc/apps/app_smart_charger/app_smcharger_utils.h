...
typedef enum {
    ...
    APP_SMCHARGER_KEY_BT_AIR_PAIRING,					// richard for UI spec
    ...
    APP_SMCHARGER_KEY_ULL_AIR_PAIRING = 9,
    APP_SMCHARGER_KEY_ENTER_FACTORY_AUTO_POWEROFF_MODE =0X0C,
    APP_SMCHARGER_KEY_EXIT_FACTORY_AUTO_POWEROFF_MODE =0X0D,   
