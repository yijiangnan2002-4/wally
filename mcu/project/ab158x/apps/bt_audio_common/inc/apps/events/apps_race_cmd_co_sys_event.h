...
typedef enum {
    ...
    APPS_RACE_CMD_CO_SYS_DUAL_CHIP_EVENT_SILENCE_DETECT,
    APPS_RACE_CMD_CO_SYS_DUAL_CHIP_EVENT_SLAVE_POWER_ON,
    APPS_RACE_CMD_CO_SYS_DUAL_CHIP_EVENT_SYNC_KEY_TABLE,
    APPS_RACE_CMD_CO_SYS_DUAL_CHIP_EVENT_SYNC_DETACHABLE_MIC_STATUS,
