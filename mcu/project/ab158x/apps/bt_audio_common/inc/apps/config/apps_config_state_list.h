...
typedef enum {
    ...
    APP_HFP_OUTGOING,                   //5
    APP_HFP_CALL_ACTIVE,
    APP_HFP_CALL_ACTIVE_WITHOUT_SCO,
    APP_HFP_TWC_INCOMING,
    APP_HFP_TWC_OUTGOING,
    APP_HFP_MULTIPARTY_CALL,                    //10
    //APP_FAKEON,
    //APP_FAKEOFF,
    //APP_DETACHING_LINK,
    //APP_TEST_MODE,
...
#define APP_HFP_CALLACTIVE  APP_HFP_CALL_ACTIVE
#define APP_HFP_CALLACTIVE_WITHOUT_SCO  APP_HFP_CALL_ACTIVE_WITHOUT_SCO
#define APP_HFP_MULTITPART_CALL  APP_HFP_MULTIPARTY_CALL
