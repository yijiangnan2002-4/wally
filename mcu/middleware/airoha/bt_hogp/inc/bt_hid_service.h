...
#ifndef _BT_HID_SERVICE_H_
#define _BT_HID_SERVICE_H_

#include "bt_hogp.h"
#include "bt_device_manager_le_config.h"

#define BT_HID_SERVICE_CONTEXT_MAX  BT_DEVICE_MANAGER_LE_BONDED_MAX

#define BT_HID_SERVICE_GET_REPORT_REPSONSE_MAX_LENGTH   250
