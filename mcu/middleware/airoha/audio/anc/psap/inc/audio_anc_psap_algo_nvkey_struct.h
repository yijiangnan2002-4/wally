 ...
 */
#ifndef _AUDIO_ANC_PSAP_ALGO_NVKEY_STRUCT_H
#define _AUDIO_ANC_PSAP_ALGO_NVKEY_STRUCT_H

#include "types.h"
#include "audio_anc_psap_user_setting_nvkey_struct.h"

/** ========================================================================================================
 * @brief Parameter for PSAP/HA AFC
 * @KeyID 0xE801
========================================================================================================== */
typedef struct {
    /** AFC Coeff **/
...
/** ========================================================================================================
 * @brief Parameter for PSAP/HA DRC
 * @KeyID 0xE802
========================================================================================================== */
typedef struct {
...
/** ========================================================================================================
 * @brief Parameter for PSAP/HA level
...
/** ========================================================================================================
 * @brief Parameter for PSAP/HA para
 * @KeyID 0xE813
========================================================================================================== */
typedef struct {
...
/** ========================================================================================================
 * @brief Parameter for PSAP/HA low cut
 * @KeyID 0xE814
========================================================================================================== */
typedef struct {
...
/** ========================================================================================================
 * @brief Parameter for PSAP/HA mode
 * @KeyID 0xE815
========================================================================================================== */
typedef struct {
...
/** ========================================================================================================
 * @brief Parameter for PSAP/HA mode EQ
 * @KeyID 0xE816 ~ 0xE81D
========================================================================================================== */
typedef struct {
...
/** ========================================================================================================
 * @brief Parameter for PSAP/HA vendor EQ
 * @KeyID 0xE81F
========================================================================================================== */
typedef struct {
...
/** ========================================================================================================
 * @brief Parameter for PSAP/HA volume
 * @KeyID 0xE820
========================================================================================================== */
typedef struct {
    U8  psap_vol_max_count;                                   /**< @Value 15 @Desc 1 */

    S8  psap_vol_table_1;                                     /**< @Value -128 @Desc 1 */
    S8  psap_vol_table_2;                                     /**< @Value -42 @Desc 1 */
    S8  psap_vol_table_3;                                     /**< @Value -39 @Desc 1 */
    S8  psap_vol_table_4;                                     /**< @Value -36 @Desc 1 */
    S8  psap_vol_table_5;                                     /**< @Value -33 @Desc 1 */
    S8  psap_vol_table_6;                                     /**< @Value -30 @Desc 1 */
    S8  psap_vol_table_7;                                     /**< @Value -27 @Desc 1 */
    S8  psap_vol_table_8;                                     /**< @Value -24 @Desc 1 */
    S8  psap_vol_table_9;                                     /**< @Value -21 @Desc 1 */
    S8  psap_vol_table_10;                                    /**< @Value -18 @Desc 1 */
    S8  psap_vol_table_11;                                    /**< @Value -15 @Desc 1 */
    S8  psap_vol_table_12;                                    /**< @Value -12 @Desc 1 */
    S8  psap_vol_table_13;                                    /**< @Value -9 @Desc 1 */
    S8  psap_vol_table_14;                                    /**< @Value -6 @Desc 1 */
    S8  psap_vol_table_15;                                    /**< @Value -3 @Desc 1 */
    S8  psap_vol_table_16;                                    /**< @Value 0 @Desc 1 */
    U8  reserved[7];                                        /**< @Value 0, 0, 0, 0, 0, 0, 0 @Desc 1 */
} PACKED psap_vol_nvdm_t;


/** ========================================================================================================
 * @brief Parameter for PSAP/HA AEA COEF
 * @KeyID 0xE821
========================================================================================================== */
typedef struct {
...
/** ========================================================================================================
 * @brief Parameter for PSAP/HA Beamforming
 * @KeyID 0xE822
========================================================================================================== */
typedef struct {
    ...
    U8  reserved_3[8];                                         /**< @Value 0 @Desc 1 */
...
/** ========================================================================================================
 * @brief Parameter for PSAP/HA SYSTEM
 * @KeyID 0xE824
========================================================================================================== */
typedef struct {
    U16 reserved;                                          /**< @Value 0 @Desc 1 */
    U8  bootup_turn_on_HA_delay_time;                      /**< @Value 0 @Desc 1 */
    U8  inear_turn_on_HA_delay_time;                       /**< @Value 0 @Desc 1 */
...
#endif /* _AUDIO_ANC_PSAP_ALGO_NVKEY_STRUCT_H */
