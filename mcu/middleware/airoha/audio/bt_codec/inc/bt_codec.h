...
typedef enum {
    ...
    BT_CODEC_MEDIA_LEQ_PARA_SEND,                         /**< Request to send LEQ gain from agent to partner. */
...
#if defined(AIR_BT_CODEC_BLE_ENABLED) || defined(AIR_BLE_ULTRA_LOW_LATENCY_ENABLE) || defined(AIR_BLE_ULTRA_LOW_LATENCY_WITH_HID_ENABLE)
/**
...
typedef enum {
    ...
    LE_AUDIO_interval_2         = 6, /**< frame duration = 2ms  */
} le_audio_interval_t;
