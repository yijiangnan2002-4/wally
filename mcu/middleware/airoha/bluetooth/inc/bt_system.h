...
#endif
#define BT_CONTROL_BLOCK_SIZE_OF_L2CAP_LE_CBFCM                     (56)     /**< The size of a control block size for LE CBFCM. */
#define BT_CONTROL_BLOCK_SIZE_OF_L2CAP_LE_ECBFCM                    (100)     /**< The size of a control block size for LE CBFCM. */
/**
...
#endif
    BT_MEMORY_CONTROL_BLOCK_L2CAP_LE_CBFCM = 0x21,      /**< LE CBFCM. */
    BT_MEMORY_CONTROL_BLOCK_L2CAP_LE_ECBFCM = 0x22,     /**< LE ECBFCM. */  
...
/**
 * @brief   Check bt_memory's free packet buffer size.
 * @param[in] type #BT_MEMORY_TX_BUFFER or #BT_MEMORY_RX_BUFFER.
 * @return  The free buffer value.
 */
uint32_t bt_memory_get_total_free_size(bt_memory_packet_t type);
