...
/**
 * @brief       This function use for alloc buffer.
 * @param[in]   buffer size, unit byte.
 * @return      buffer pointer, if fail, return NULL.
 */
void *bt_os_layer_mem_alloc(uint32_t size);

/**
 * @brief       This function use for free buffer, this buffer is alloced by bt_os_layer_mem_alloc.
