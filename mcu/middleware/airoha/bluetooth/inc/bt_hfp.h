...
#define BT_HFP_BIND_FEATURE_IND             (BT_MODULE_HFP | 0x01c)                 /**< The BIND Feature Indication is triggered when the AG supported HF indicators are fetched with the #bt_hfp_hf_indicators_feature_ind_t payload. */
#define BT_HFP_HF_INDICATOS_ENABLE_IND      (BT_MODULE_HFP | 0x01d)                 /**< The HF Indicators Enable Indication is triggered when the AG enabled HF indicators are fetched when the #bt_hfp_hf_indicators_enable_ind_t payload. */
#define BT_HFP_AG_INDICATORS_ENABLE_IND     (BT_MODULE_HFP | 0x01e)                 /**< The HFP AG Indicators Enable Indication is triggered when the HF enabled AG indicators are fetched with the #bt_hfp_ag_indicators_enable_ind_t payload. */
#define BT_HFP_OPERATOR_FORMAT_IND          (BT_MODULE_HFP | 0x01f)                 /**< The HFP Operator Format Indication is triggered then the HF set operator format to AG is fetched with the #bt_hfp_operator_format_ind_t payload. */
#define BT_HFP_QUERY_OPERATOR_IND           (BT_MODULE_HFP | 0x020)                 /**< The HFP Query Operator Indication is triggered when the HF query the operator from AG is fetched with the #bt_hfp_query_operator_ind_t payload. */
#define BT_HFP_ERROR_CODE_ENABLE_IND        (BT_MODULE_HFP | 0x021)                 /**< The HFP Error Code Enable Indication is triggered when the HFP enable or disable the error result code in AG is fetched with the #bt_hfp_error_code_enable_ind_t payload. */
#define BT_HFP_CODEC_CONNECTION_IND         (BT_MODULE_HFP | 0x022)                 /**< The HFP Codec Connection Indication is triggered when HF initiate a codec connection is fetched with #bt_hfp_codec_connection_ind_t payload. */
#define BT_HFP_ANSWER_CALL_IND              (BT_MODULE_HFP | 0x023)                 /**< The HFP Answer Call Indication is triggered when HF answer an incoming call is fetched with payload #bt_hfp_answer_call_ind_t payload. */
#define BT_HFP_TERMINATE_CALL_IND           (BT_MODULE_HFP | 0x024)                 /**< The HFP Terminate Call Indication is triggered when HF reject an incoming call or hang up an active call is fetched with payload #bt_hfp_terminate_call_ind_t payload. */
#define BT_HFP_DIAL_NUMBER_IND              (BT_MODULE_HFP | 0x025)                 /**< The HFP Dial Number Indication is triggered when HF dial a number is fetched with payload #bt_hfp_dial_number_ind_t payload. */
#define BT_HFP_DIAL_MEMORY_IND              (BT_MODULE_HFP | 0x026)                 /**< The HFP Dial Memory Indication is triggered when HF dial memory is fetched with payload #bt_hfp_dial_memory_ind_t payload. */
#define BT_HFP_DIAL_LAST_IND                (BT_MODULE_HFP | 0x027)                 /**< The HFP Dial Last Indication is triggered when HF dial last number is fetched with payload #bt_hfp_dial_last_ind_t payload. */
#define BT_HFP_CALL_WAITING_ENABLE_IND      (BT_MODULE_HFP | 0x028)                 /**< The HFP Call Waiting Enable Indication is triggered when HF enables or disables call waiting notification on AG is fetched with #bt_hfp_call_waiting_enable_ind_t payload. */
#define BT_HFP_CALLER_ID_ENABLE_IND         (BT_MODULE_HFP | 0x029)                 /**< The HFP Caller Id Enable Indication is triggered when HF enables or disables caller id notification is fetched with #bt_hfp_caller_id_enable_ind_t payload. */
#define BT_HFP_DTMF_CODE_IND                (BT_MODULE_HFP | 0x02a)                 /**< The HFP DTMF Code Indication is triggered when HF sends a DTMF code to AG is fetched with #bt_hfp_dtmf_code_ind_t payload. */
#define BT_HFP_QUERY_SUBSCRIBER_NUMBER_IND  (BT_MODULE_HFP | 0x02b)                 /**< The HFP Query Subscriber Number Indication is triggered when HF query subscriber number on AG is fetched with payload #bt_hfp_query_subscriber_number_ind_t payload. */
#define BT_HFP_QUERY_CALL_LIST_IND          (BT_MODULE_HFP | 0x02c)                 /**< The HFP Query Call List Indication is triggered when HF query the call list on AG is fetched with payload #bt_hfp_query_call_list_ind_t payload. */
#define BT_HFP_HOLD_CALL_IND                (BT_MODULE_HFP | 0x02d)                 /**< The HFP Hold Call Indication is triggered when HF hold or release call is fetched with payload #bt_hfp_hold_call_ind_t. */
#define BT_HFP_READY_TO_SEND_IND            (BT_MODULE_HFP | 0x02e)                 /**< The HFP Ready To Send Indication is triggered when the Bluetooth TX buffer has free space for sending data is fetched with payload #bt_hfp_ready_to_send_ind_t payload. */
...
/**
 * @brief The structure defines the HFP hands-free features.
 */
typedef uint16_t bt_hfp_hf_feature_t;
#define BT_HFP_HF_FEATURE_ECHO_NOISE            0x0001          /**< Echo canceling and/or noise reduction function. */
#define BT_HFP_HF_FEATURE_3_WAY                 0x0002          /**< 3-way calling. */
#define BT_HFP_HF_FEATURE_CLI_PRESENTATION      0x0004          /**< CLI presentation capability. */
#define BT_HFP_HF_FEATURE_VOICE_RECOGNITION     0x0008          /**< Voice recognition activation. */
#define BT_HFP_HF_FEATURE_REMOVE_VOLUME         0x0010          /**< Remote volume control. */
#define BT_HFP_HF_FEATURE_ENHANCED_CALL_STATUS  0x0020          /**< Enhanced call status. */
#define BT_HFP_HF_FEATURE_ENHANCED_CALL_CONTROL 0x0040          /**< Enhanced call control. */
#define BT_HFP_HF_FEATURE_CODEC_NEGOTITATION    0x0080          /**< Codec negotiation. */
#define BT_HFP_HF_FEATURE_HF_INDICATORS         0x0100          /**< HF indicators. */
#define BT_HFP_HF_FEATURE_ESCO_S4_SETTINGS      0x0100          /**< eSCO S4 and T2 Settings Supported. */
...
/**
 * @brief This structure defines the HFP role.
 */
typedef uint8_t bt_hfp_role_t;
#define BT_HFP_ROLE_HF              0x00            /**<  HF role.  */
#define BT_HFP_ROLE_AG              0x01            /**<  AG role.  */
...
/**
 * @brief This structure defines the AG indicators.
 */
typedef uint8_t bt_hfp_ag_indicators_t;
#define BT_HFP_AG_INDICATORS_SERVICE    0x01        /**<  The service indicators.  */
#define BT_HFP_AG_INDICATORS_CALL       0x02        /**<  The call indicators.  */
#define BT_HFP_AG_INDICATORS_CALL_SETUP 0x04        /**<  The call setup indicators.  */
#define BT_HFP_AG_INDICATORS_CALL_HELD  0x08        /**<  The call held indicators.  */
#define BT_HFP_AG_INDICATORS_SIGNAL     0x10        /**<  The signal indicators.  */
#define BT_HFP_AG_INDICATORS_ROAM       0x20        /**<  The roaming indicators.  */
#define BT_HFP_AG_INDICATORS_BATTERY    0x40        /**<  The battery indicators.  */
#define BT_HFP_AG_INDICATORS_ALL        0xFF        /**<  All AG indicators.  */
#define BT_HFP_AG_INDICATORS_NUM        0x07        /**<  The number of AG indicators.  */

/**
 * @brief This structure defines the operator format.
 */
typedef uint8_t bt_hfp_operator_format_t;
#define BT_HFP_OPERATOR_FORMAT_LONG_ALPHANUMERIC 0x00   /**<  The long alphanumeric format. */

/**
 * @brief This structure defines the hold call type.
 */
typedef uint8_t bt_hfp_hold_call_t;
#define BT_HFP_HOLD_CALL_RELEASE_ALL_HELD               0x00    /**<  Release all held calls or set User Determined User Busy (UDUB) for a waiting call.  */
#define BT_HFP_HOLD_CALL_RELEASE_ACTIVE_ACCEPT_OTHER    0x01    /**<  Release all active calls and accept the other held or waiting call.  */
#define BT_HFP_HOLD_CALL_RELEASE_SPECIAL                0x02    /**<  Release a specific call.  */
#define BT_HFP_HOLD_CALL_HOLD_ACTIVE_ACCEPT_OTHER       0x03    /**<  Place all active calls on hold and accept the other held or waiting call.  */
#define BT_HFP_HOLD_CALL_HOLD_SPECIAL                   0x04    /**<  Place a specific call on hold.  */
#define BT_HFP_HOLD_CALL_ADD_HELD_TO_CONVERSATION       0x05    /**<  Add a held call to the conversation.  */
#define BT_HFP_HOLD_CALL_EXPLICIT_TRANSFER              0x06    /**<  Connect two calls and disconnect the AG from both calls.  */
...
/**
 *  @brief This structure defines the initialization parameters of the HF.
 */
typedef struct {
...
/**
 *  @brief The structure defines the initialization parameters of the AG.
 */
typedef struct {
    bt_hfp_ag_feature_t             support_features;                               /**<  The supported features in AG. */
    bt_hfp_ag_hold_feature_t        support_hold_feature;                           /**<  The supported hold features in AG. */
    bt_hfp_audio_codec_type_t       support_codec;                                  /**<  The supported codec in AG. */
    uint32_t                        service_indicator_value;                        /**<  The value of service indicator in AG. */
    uint32_t                        call_indicator_value;                           /**<  The value of call indicator in AG. */
    uint32_t                        call_setup_indicator_value;                     /**<  The value of call setup indicator in AG. */
    uint32_t                        call_held_indicator_value;                      /**<  The value of call held indicator in AG. */
    uint32_t                        signal_indicator_value;                         /**<  The value of signal indicator in AG. */
    uint32_t                        roam_indicator_value;                           /**<  The value of roam indicator in AG. */
    uint32_t                        battery_indicator_value;                        /**<  The value of battery indicator in AG. */
} bt_hfp_ag_init_param_t;
...
typedef struct {
    ...
    bt_hfp_role_t         role;                   /**<  The remote HFP role of the remote device. */
...
/**
 *  @brief This structure defines the parameter type in the callback for the event #BT_HFP_BRSF_FEATURES_IND to indicate the supported features of a AG remote device.
 */
typedef struct {
    uint32_t                    handle;               /**<  The HFP handle of the current connection. */
    uint32_t                    ag_feature;           /**<  The supported features of a remote AG device. */
} bt_hfp_feature_ind_t;


/**
 * @brief This structure defines the parameter type on the callback for the event #BT_HFP_BRSF_FEATURES_IND to indicate the supported features of a remote HF device.
 */
typedef struct {
    uint32_t                    handle;               /**<  The HFP handle of the current connection. */
    uint32_t                    hf_feature;           /**<  The supported features of a remote HF device. */
} bt_hfp_hf_feature_ind_t;
...
typedef struct {
    uint32_t                        handle;                 /**< The HFP handle of the current connection. */
    bt_hfp_hf_indicators_feature_t  hf_indicators;          /**< Whether the HF indicators feature is enabled or disabled. */
    bool                            enable;                 /**< The enable or disable of current HF indicatos. */
} bt_hfp_hf_indicators_enable_ind_t;

/**
 *  @brief This structure defines the parameter type in the callback for the event #BT_HFP_AG_INDICATORS_ENABLE_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
    bt_hfp_ag_indicators_t      ag_indicators;              /**<  The AG indicators to indicate. */
    bt_hfp_indicator_status_t   status;                     /**<  The status of AG indicators. */
} bt_hfp_ag_indicators_enable_ind_t;

/**
 *  @brief This structure defines the parameter type in the callback for the event #BT_HFP_OPERATOR_FORMAT_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
    bt_hfp_operator_format_t    format;                     /**<  The operator format that HF set. */
} bt_hfp_operator_format_ind_t;

/**
 * @brief This structure defines the parameter type in the callback for the event #BT_HFP_QUERY_OPERATOR_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
} bt_hfp_query_operator_ind_t;

/**
 * @brief This structure defines the parameter type in the callback for the event #BT_HFP_ERROR_CODE_ENABLE_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
    bool                        enable;                     /**<  The enable status of error result code. */
} bt_hfp_error_code_enable_ind_t;

/**
 * @brief This structure defines the paramter type in the callback for the event #BT_HFP_CODEC_CONNECTION_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
} bt_hfp_codec_connection_ind_t;

/**
 * @brief This structure defines the parameter type in the callback for the event #BT_HFP_ANSWER_CALL_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
} bt_hfp_answer_call_ind_t;

/**
 * @brief This structure defines the parameter type in the callback for the event #BT_HFP_TERMINATE_CALL_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
} bt_hfp_terminate_call_ind_t;

/**
 * @brief This structure defines the parameter type in the callback for the event #BT_HFP_DIAL_NUMBER_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
    char                        *number;                    /**<  The number to dial. */
    uint32_t                    number_length;              /**<  The length of the number to dial. */
} bt_hfp_dial_number_ind_t;

/**
 * @brief This structure defines the parameter type in the callback for the event #BT_HFP_DIAL_MEMORY_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
    char                        *memory;                    /**<  The memory to dial. */
    uint32_t                    memory_length;              /**<  The length of the memory to dial. */
} bt_hfp_dial_memory_ind_t;

/**
 * @brief This structure defines the parameter type in the callback for the event #BT_HFP_CALL_WAITING_ENABLE_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
    bool                        enable;                     /**<  The enable status of the call waiting notification. */
} bt_hfp_call_waiting_enable_ind_t;

/**
 * @brief This structure defines the parameter type in the callback for the event #BT_HFP_DIAL_LAST_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
} bt_hfp_dial_last_ind_t;

/**
 * @brief This structure defines the parameter type in the callback for the event #BT_HFP_CALLER_ID_ENABLE_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
    bool                        enable;                     /**<  The enable status of the caller id notification. */
} bt_hfp_caller_id_enable_ind_t;

/**
 * @brief This structure defines the parameter type in the callback for the event #BT_HFP_DTMF_CODE_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
    char                        code;                       /**<  The DTMF code received from a remote HF device. */
} bt_hfp_dtmf_code_ind_t;

/**
 * @brief This structure defines the parameter type in the callback for the event #BT_HFP_QUERY_SUBSCRIBER_NUMBER_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
} bt_hfp_query_subscriber_number_ind_t;

/**
 * @brief This stucture defines the parameter type in the callback for the event #BT_HFP_QUERY_CALL_LIST_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection. */
} bt_hfp_query_call_list_ind_t;

/**
 * @brief This structure defines the parameter type in the callback for the event #BT_HFP_HOLD_CALL_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the currnt connection.  */
    bt_hfp_hold_call_t          type;                       /**<  The hold call type.  */
    uint8_t                     index;                      /**<  The index of hold special or release special type.  */
} bt_hfp_hold_call_ind_t;

/**
 * @brief The structure defines the parameter type in the callback for the event #BT_HFP_READY_TO_SEND_IND.
 */
typedef struct {
    uint32_t                    handle;                     /**<  The HFP handle of the current connection.  */
} bt_hfp_ready_to_send_ind_t;
...
/**
 * @brief                                         This function sends a HFP connect request to the AG or HF.
 *                                                The event #BT_HFP_SLC_CONNECTING_IND returns when the SLC is connecting.
 *                                                The event #BT_HFP_SLC_CONNECTED_IND returns when HFP negotiation is complete.
 * @param[out] handle                             is the channel handle returned.
 * @param[in] address                             is the Bluetooth address of the AG.
 * @param[in] role                                is the current role.
 * @return                                        #BT_STATUS_SUCCESS, the operation completed successfully.
 *                                                #BT_STATUS_FAIL, the operation has failed.
 *                                                #BT_STATUS_OUT_OF_MEMORY, out of memory.
 */
bt_status_t bt_hfp_connect_with_role(uint32_t *handle, bt_bd_addr_t *address, bt_hfp_role_t role);


/**
 * @brief                                         This function responds to a connection request from AG.
 *                                                Call this API to accept or reject the connection, when #BT_HFP_CONNECT_REQUEST_IND is received.
...
/**
 * @brief                                         This function sends an AG indicators report to the HF.
 * @param[in] handle                              is the handle of the current connection.
 * @param[in] indicator                           is the AG indicator that must be sent.
 * @param[in] value                               is the value of AG indicator.
 * @return                                        #BT_STATUS_SUCCESS, the operation completed successfully.
 *                                                #BT_STATUS_FAIL, the operation has failed.
 *                                                #BT_STATUS_OUT_OF_MEMORY, out of memory.
 */
bt_status_t bt_hfp_send_status_indication(uint32_t handle, bt_hfp_ag_indicators_t indicator, uint32_t value);
...
/**
 * @brief                                         This function gets the initialization settings of AG. The API is invoked by the SDP and SLC process and should be implemented by the application.
 * @param[out] init_params                        is the settings to initialize AG.
 * @return                                        #BT_STATUS_SUCCESS, the operation completed successfully, otherwise it failed.
 */
...
/**
 * @brief                                         This function enables and disables the HFP HF service record.
 * @param[in] enable                              is the configuration to decide whether enable HFP HF service record.
 */
void bt_hfp_enable_service_record(bool enable);

/**
 * @brief                                         This function checks whether the HFP HF service record is enabled.
 * @return                                       If return true, the HFP HF service record is enabled. Otherwise, it is disabled.
 */
bool bt_hfp_check_service_record(void);

/**
 * @brief                                         This function enables and disables the HFP AG service record.
 * @param[in] enable                              is the configuration to decide whether enable HFP AG service record.
 */
void bt_hfp_enable_ag_service_record(bool enable);

/**
 * @brief                                         This function checks whether the HFP AG service record is enable.
 * @return                                        If the return is true, the HFP AG service record is enabled. Otherwise, it is disabled.
 */
bool bt_hfp_check_ag_service_record(void);
