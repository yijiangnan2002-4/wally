...
#define  BT_GAP_LE_EDRLE_4M_PHY       0x03                      /**< EDRLE 4M phy. */
#define  BT_GAP_LE_EDRLE_8M_PHY       0x04                      /**< EDRLE 4M phy. */
...
/**
 * @brief     This is a user-defined API that returns a special and new local keys. Because of the new local keys, the values of LTK, EDIV, Rand and CSRK should be regenerated each time before they are distributed.
 * @param[in] handle   is the connection handle.
 * @return    A pointer to the local key and cannot be NULL. It's recommended to use a global variable to store the local key.
 */
