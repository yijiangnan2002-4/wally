 ...
 * @{
 * This section introduces the following modules - the basic types, the memory management, the power management, the host controller interface, the universally unique identifier. It also provides the terms and acronyms, definitions and structures.
 * @defgroup Bluetoothtype Basic types
 * @{
