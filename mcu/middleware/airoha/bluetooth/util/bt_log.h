...
/*  "[AVM] [BTAVM] set audio play en, handle:0x%08x, status:0x%08x"  */
extern const char BTAVM_014[];
/*  "[AVM] [BTAVM]Rej LMP 1M"  */
extern const char BTAVM_015[];
/*  "[AVM] get_gpt_count: gpt_count: %x"  */
extern const char BTAVM_016[];
/*  "[AVM] clear_gpt_count"  */
extern const char BTAVM_017[];
/*  "[AVM] "unlock_bt_sleep"  */
extern const char BTAVM_018[];
/*  "[AVM] [BTAVM esco stream control value = %d"  */
extern const char BTAVM_019[];
...
/*"bt_hci_is_cmd_in_rho_white_list, cmd_code = %x, result = %d"*/
extern const char BTHCI_123[];
/*"bt_hci_is_le_sub_evt_in_rho_white_list, le_sub_evt_code = %x, result = true"*/
extern const char BTHCI_124[];
/*"bt_hci_is_le_sub_evt_in_rho_white_list, le_sub_evt_code = %x, result = false"*/
extern const char BTHCI_125[];
/*"bt_hci_is_evt_in_rho_white_list, evt_code = %x, result = %d"*/
extern const char BTHCI_126[];
...
/* "[L2CAP_LE_COC] send data status:%x cid:%x length:%d num_of_kframe:%d length_remained:%d\n"; */
extern const char BTL2CAP_280[];
/* "[L2CAP_LE_COC] mask= %x event:%x \n"; */
extern const char BTL2CAP_281[];
/* "[L2CAP_LE_COC] connect num_of_channels:%d le_psm:%x (coc= %x)\n"; */
extern const char BTL2CAP_282[];
...
/*  "[SM] key request handle = %02x, sm ongoing handle = %02x"  */
extern const char BTSM_167[];
...
/*  "[AWS_MCE] deinit" */
extern const char BTAWS_066[];
/*  "[AWS_MCE] update mode: 0x%x=>0x%x"  */
extern const char BTAWS_067[];
...
/*  "[ULL] bt_ull_le_air_hid_cis_conn_proc, timer 0x%08x expired" */
extern const char BTULL_030[];
/*  "[ULL] bt_ull_le_air_hid_cis_conn_proc, event 0x%08x complete" */
extern const char BTULL_031[];
/*  "[ULL] bt_ull_le_air_hid_event_callback, timer 0x%08x expired" */
extern const char BTULL_032[];
/*  "[ULL] bt_ull_le_air_hid_event_callback, event 0x%08x complete" */
extern const char BTULL_033[];
/*  "[ULL] bt_ull_le_air_hid_event_callback, disconnect air cis because of low resource, handle: 0x%x" */
extern const char BTULL_034[];
/*  "bt_ull_le_air_hid_event_callback, not find air cis info, handle : 0x%x" */
extern const char BTULL_035[];
/*  "[ULL] bt_ull_le_set_air_hid_cig_parameters, out of memory" */
extern const char BTULL_036[];
/*  "[ULL] bt_ull_le_create_air_hid_cis, out of memory" */
extern const char BTULL_037[];
/*  "[ULL] bt_ull_le_sync_air_hid_cis, out of memory" */
extern const char BTULL_038[];
/*  "[ULL] bt_ull_le_disconnect_air_hid_cis, not find air cis info, handle: 0x%x" */
extern const char BTULL_039[];
/*  "[ULL] bt_ull_le_remove_air_hid_iso_data_path, not find air cis info, handle: 0x%x" */
extern const char BTULL_03A[];
/*  "[ULL] bt_ull_le_setup_air_hid_iso_data_path, not find air cis info, handle: 0x%x" */
extern const char BTULL_03B[];
...
/*  "[AVDTP] MHDT SUPPORT IND, result:%d, feature_operation:%d, local_mHDT_support: %d, remote_mHDT_support: %d"  */
extern const char BTA2DP_107[];
/*  "[AIRUPDAT] Alloc channel, chnl: 0x%08x\r\n"  */
extern const char BTAIRUPDAT_001[];
/*  "[AIRUPDAT] special link check(), conn: 0x%08x, special: %d\r\n"  */
extern const char BTAIRUPDAT_002[];
...
/*  "[HFP] connection already exist!"  */
extern const char BTHFP_100[];
/*  "[HFP] alloc connection: 0x%x"  */
extern const char BTHFP_101[];
/*  "[HFP] free connection: 0x%x"  */
extern const char BTHFP_102[];
/*  "[HFP] state machine in, connection: 0x%x(0x%x, 0x%x) event: 0x%x"  */
extern const char BTHFP_103[];
/*  "[HFP] state machine out, connection: 0x%x(0x%x, 0x%x) event: 0x%x"  */
extern const char BTHFP_104[];
/*  "[HFP] SDP callback, event: 0x%x connection: 0x%x"  */
extern const char BTHFP_105[];
/*  "[HFP] RFCOMM callback, event: 0x%x"  */
extern const char BTHFP_106[];
/*  "[HFP] hold packet: 0x%x"  */
extern const char BTHFP_107[];
/*  "[HFP] release packet: 0x%x"  */
extern const char BTHFP_108[];
/*  "[HFP] parse at parameter, type: 0x%x"  */
extern const char BTHFP_109[];
/*  "[HFP] parse at parameter, key: (%d, %c) value: (%d, %c) "  */
extern const char BTHFP_110[];
/*  "[HFP][stack] push, type: 0x%x start with %c"  */
extern const char BTHFP_111[];
/*  "[HFP][stack] pop, type: 0x%x start with %c"  */
extern const char BTHFP_112[];
