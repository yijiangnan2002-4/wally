...
#define BT_SINK_SRV_LE_CALL_MAX_URI_LENGTH           (20)

typedef struct bt_sink_srv_le_call_structure {
    struct bt_sink_srv_le_call_structure *next;
    bool used;
