...
#ifndef __RACE_CMD_SIMPLETEST_H__
#define __RACE_CMD_SIMPLETEST_H__

#include "stdint.h"
#include "race_cmd.h"

/* ----------------------------------------------------------------------
** Specify tuning packet buffer size in 32-bit words
** ------------------------------------------------------------------- */

#define RACE_CMD_SIMPLE_TEST_ENABLE   (1)


#define RACE_SIMPLE_TEST    0x2E20
...
////////////////////////////////////////////////////////////////////////////////
/*!
  @brief Process Simple Test related RACE commands.
...
#endif /* __RACE_CMD_SIMPLETEST_H__ */
