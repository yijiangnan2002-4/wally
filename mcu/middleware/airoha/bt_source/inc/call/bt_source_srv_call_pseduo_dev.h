...
#define BT_SOURCE_SRV_CALL_PSD_EVENT_SCO_DISCONNECT_REQ       0x85

#define BT_SOURCE_SRV_CALL_PSD_EVENT_AUDIO_SRC_TAKE_SUCCESS   0xA0
#define BT_SOURCE_SRV_CALL_PSD_EVENT_AUDIO_SRC_GIVE_SUCCESS   0xA1
#define BT_SOURCE_SRV_CALL_PSD_EVENT_AUDIO_SRC_REJECT         0xA2
#define BT_SOURCE_SRV_CALL_PSD_EVENT_AUDIO_SRC_SUSPEND        0xA3
