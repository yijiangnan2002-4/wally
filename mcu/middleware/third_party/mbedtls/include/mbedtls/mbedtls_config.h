...
/**
 * \def MBEDTLS_ANSI_X963_KDF_C
 *
 * Enable the ANSI X9.63 KDF algorithm (SEC1, 3.6.1 ANSI X9.63 Key Derivation Function).
 *
 * Module:  airoha/ans_x963_kdf.c
 * Caller:
 *
 * Requires: MBEDTLS_MD_C
 *
 * This module adds support for the ANSI X9.63 KDF algorithm.
 */
#define MBEDTLS_ANSI_X963_KDF_C
