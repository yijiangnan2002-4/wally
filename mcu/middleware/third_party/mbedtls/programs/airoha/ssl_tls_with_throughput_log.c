...
static int ssl_prepare_record_content( mbedtls_ssl_context *ssl )
{
    ...
    {
#ifdef MBEDTLS_TEST_LOG
        extern uint32_t g_decrypt_time;
        extern mbedtls_example_get_current_time_in_ms();
        unsigned int start_ms = mbedtls_example_get_current_time_in_ms();
#endif
...
#ifdef MBEDTLS_TEST_LOG
        unsigned int end_ms = mbedtls_example_get_current_time_in_ms();
        g_decrypt_time += (end_ms - start_ms);
#endif
