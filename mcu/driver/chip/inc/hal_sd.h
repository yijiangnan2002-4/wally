 ...
 *       }
 *
 *       if (HAL_SD_STATUS_OK != hal_sd_write_blocks_dma_blcoking(sd_port, &write_buffer, start_address, block_number)) {
 *           // Error handler.
 *       }
 *    @endcode
 ...
 *       }
 *
 *       if (HAL_SD_STATUS_OK != hal_sd_write_blocks_dma(sd_port, &write_buffer, start_address, block_number)) {
 *           // Error handler.
 *       }
 *    @endcode
