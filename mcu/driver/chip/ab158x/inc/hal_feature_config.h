...
#elif defined(__UBL__)  /*bootloader  */
...
/**
 * Only enable usb hal when usb dfu is open, for code size reduce.
 */
#ifdef AIR_BL_USB_HID_DFU_ENABLE
#define HAL_USB_MODULE_ENABLED
#endif
...
#define HAL_WDT_MODULE_ENABLED
#define HAL_DWT_MODULE_ENABLED
#define HAL_SD_MODULE_ENABLED        //EMMC
//#define HAL_SDIO_MODULE_ENABLED   //NO HW
#define HAL_TRNG_MODULE_ENABLED
#define HAL_PMU_MODULE_ENABLED
#define HAL_DCXO_MODULE_ENABLED
#define HAL_SLEEP_MANAGER_ENABLED
...
#define HAL_SECURITY_MODULE_ENABLED
//#define HAL_IRRX_MODULE_ENABLED     //NO HW
