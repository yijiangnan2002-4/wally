...
//  ��������������һ�κ�ʱԼ 4*(55ms + delay_time_ms) ms
...
//cal gain     
    ...
    gain_r0x12 = gain_r0x12<<4; //gain д���Ĵ�����4λ
...
k2 = %d; 1f1x = %4d;2f1x = %d  ",\
    ...
    printf("HX300X   ...R10 = 0x%x,R11 = 0x%x,R12 = 0x%x,R13 = 0x%x,  ", Reg[0],
            Reg[1],Reg[2],Reg[3]);
    printf("HX300X   ...data_ps Code = %4d, read_ps_k = %4d  ", data_ps,read_ps_k);//���۽ṹ��
    //printf("HX300X   ");
    cali_process |= CALI_STEP3;
	
	//data_ps:�ҿ�����ֵ ��read_ps_k�����۽ṹ���ֵ
...
void hx300x_Set_cur(void)
{
    ...
    TYHX_Write_REG(0x10, reg_10);       //Flash �����leddr
    TYHX_Write_REG(0x13, reg_13);  //Flash �����reg_13_new 	
}
...
{	
    ...
    TYHX_Write_REG(0x12, reg_12);  //Flash �����gain
}
...
void hx300x_PowerDown(void)
{
    ...
    TYHX_Write_REG(0x00, 0x05);	 		                                //bit1:PEN  �رռ����Դ
}

void hx300x_PowerOn(void)
{
    // enable LDO
    TYHX_Write_REG(0x00, 0x0A);	 		                                //bit1:PEN  �򿪼����Դ
}
