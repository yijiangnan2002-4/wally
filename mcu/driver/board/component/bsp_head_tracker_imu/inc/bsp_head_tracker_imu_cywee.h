...
#ifndef BSP_HEAD_TRACKER_IMU_CYWEE_H
#define BSP_HEAD_TRACKER_IMU_CYWEE_H
...
typedef union {
    bsp_head_tracker_imu_config_t   user_data_init;
    uint32_t                        user_data_cmd;
} head_tracker_imu_cywee_service_user_data_t;
...
#endif /* BSP_HEAD_TRACKER_IMU_CYWEE_H */
