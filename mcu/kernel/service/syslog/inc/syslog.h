...
typedef enum {
    ...
    SYSLOG_PORT_TYPE_FLASH,      /**<  using the FLASH port as a SYSLOG port */
...
do { \
    ...
    print_module_msgid_log_debug(&log_control_block_##module, \
                                        (msg_id_string), \
                                        (arg_cnt),  \
                                        ##__VA_ARGS__); \
} while (0)
...
do { \
    ...
    (void)(data); \
    (void)(len); \
    syslog_port_dummy(message, ##__VA_ARGS__); \
} while (0)
#define LOG_MSGID_D(module, message, arg_cnt, ...) \
do { \
    extern log_control_block_t log_control_block_##module; \
...
do { \
    ...
    print_module_msgid_log_info(&log_control_block_##module, \
                                        (msg_id_string), \
                                        (arg_cnt),  \
                                        ##__VA_ARGS__); \
} while (0)
...
do { \
    ...
    print_module_msgid_log_warning(&log_control_block_##module, \
                                        (msg_id_string), \
                                        (arg_cnt),  \
                                        ##__VA_ARGS__); \
} while (0)
...
do { \
    ...
    print_module_msgid_log_error(&log_control_block_##module, \
                                        (msg_id_string), \
                                        (arg_cnt),  \
                                        ##__VA_ARGS__); \
} while (0)
