...
void print_module_msgid_log_debug(void *handle, const char *message, uint32_t arg_cnt, ...);
void print_module_msgid_log_info(void *handle, const char *message, uint32_t arg_cnt, ...);
void print_module_msgid_log_warning(void *handle, const char *message, uint32_t arg_cnt, ...);
void print_module_msgid_log_error(void *handle, const char *message, uint32_t arg_cnt, ...);
