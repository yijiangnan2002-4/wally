...
class DMM_scene:
    ...
    def print(self):
        print('cpnt_name:{:<10} rgn_name:{:<20} grp_id:{:<3} attr:{:<8} sub_cpnt_name:{:<10} sub_cpnt_size:{:<8}'.format(
                self.cpnt_name,
                self.rgn_name,
                self.grp_id,
                self.attr,
            ...
            for _tmp_mapping in self.__mapping:
                ...
                for _tmp_entry in _tmp_mapping.scenes:
                    if _tmp_entry.attr == 'Head':
                        ...
                        if len(_tmp_entry.sub_cpnt_size.strip()) != 0:
                        ...
                        # The original region_size needs to be replaced according to the calculated value.
                        '''
