...
# This option is used to enable multiple stream out.
# It must be turned on/off for both DSP and MCU, otherwise, it will not work.
AIR_AUDIO_MULTIPLE_STREAM_OUT_ENABLE = y

# This option is used to enable LR volume balance.
AIR_AUDIO_DOWNLINK_SW_GAIN_ENABLE = y
...
AIR_AUDIO_VAD_ON_MUTE_ENABLE = n
...
# This option is to choose the HFP stream rate. Default setting is dynamic.
# It must be set to the same value for both DSP and MCU, otherwise, it will not work.
# Usage: dynamic, 48k
#                  dynamic : downlink rate will be handled by scenario itself.
#                  48k     : downlink rate will be fixed in 48k Hz.
AIR_HFP_DL_STREAM_RATE = 48k

# This option is to choose the A2DP stream rate. Default setting is dynamic.
# It must be set to the same value for both DSP and MCU, otherwise, it will not work.
# Usage: dynamic, 48k
#                  dynamic : downlink rate will be handled by scenario itself.
#                  48k     : downlink rate will be fixed in 48k Hz.
AIR_A2DP_DL_STREAM_RATE = 48k

# This option is to choose the LE call DL stream rate. Default setting is dynamic.
# It must be set to the same value for both DSP and MCU, otherwise, it will not work.
# Usage: dynamic, 48k
#                  dynamic : downlink rate will be handled by scenario itself.
#                  48k     : downlink rate will be fixed in 48k Hz.
AIR_LE_CALL_DL_STREAM_RATE = 48k
