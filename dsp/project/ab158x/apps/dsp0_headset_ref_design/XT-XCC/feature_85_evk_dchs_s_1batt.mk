...
# This option is used to enable/disable dchs ainr.
AIR_DCHS_OFF_AINR_ENABLE = n
###### Scenario ######
...
AIR_ECNR_CONFIG_TYPE = 3RD_PARTY_AI_NR_PRO_BROADSIDE_SEPARATE_MODE
...
# It must be set to the same value for both DSP and MCU, otherwise, it will not work.
AIR_DUAL_CHIP_AUDIO_INTERFACE = uart
