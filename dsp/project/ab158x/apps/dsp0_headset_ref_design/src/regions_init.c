...
extern unsigned int _noncached_sysram_data_start[];
extern unsigned int _noncached_sysram_bss_end[];
extern unsigned int _cached_sysram_text_start[];
extern unsigned int _cached_sysram_bss_end[];
#endif 
...
#if defined(AIR_BTA_IC_PREMIUM_G3) || defined(AIR_BTA_IC_STEREO_HIGH_G3) 
	{"cached_sysram_dsp", _cached_sysram_text_start, _cached_sysram_bss_end, 1},
	{"noncached_sysram_dsp", _noncached_sysram_data_start, _noncached_sysram_bss_end, 1},
#endif 
    {0, 0, 0, 0}
};
