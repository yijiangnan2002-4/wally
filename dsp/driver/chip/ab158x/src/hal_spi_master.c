...
ATTR_TEXT_IN_RAM_FOR_MASK_IRQ hal_spi_master_status_t hal_spi_master_init(hal_spi_master_port_t master_port,
                                            hal_spi_master_config_t *spi_config)
{
...
ATTR_TEXT_IN_RAM_FOR_MASK_IRQ hal_spi_master_status_t hal_spi_master_deinit(hal_spi_master_port_t master_port)
{
    uint32_t saved_mask;
    if (!is_master_port(master_port)) {
        return HAL_SPI_MASTER_STATUS_ERROR_PORT;
...
ATTR_TEXT_IN_RAM_FOR_MASK_IRQ static hal_spi_master_status_t spi_nb_try_to_pop_and_start(hal_spi_master_port_t spi_port)
{
    uint32_t saved_mask;
...
ATTR_TEXT_IN_RAM_FOR_MASK_IRQ hal_spi_master_status_t hal_spi_master_send_and_receive_dma_no_busy(hal_spi_master_port_t spi_port, hal_spi_send_and_receive_config_ex_no_busy_t *spi_send_and_receive_config_no_busy_ex)
{
    uint32_t saved_mask;
