...
ATTR_TEXT_IN_RAM_FOR_MASK_IRQ void spi_sw_fifo_init(uint32_t spi_port)
{
...
ATTR_TEXT_IN_RAM_FOR_MASK_IRQ uint32_t spi_push_sw_fifo(uint32_t spi_port, hal_spi_sw_fifo_node_t *tansfer_config, uint32_t transfer_cnt)
{
...
ATTR_TEXT_IN_RAM_FOR_MASK_IRQ uint32_t  spi_pop_sw_fifo(uint32_t spi_port, hal_spi_sw_fifo_node_t *transfer_config, uint32_t transfer_cnt)
{
    uint32_t temp_cnt0 = 0;
    uint32_t temp_cnt1 = 0;
    uint32_t temp_cnt2 = 0;
...
ATTR_TEXT_IN_RAM_FOR_MASK_IRQ int32_t spi_get_sw_fifo_remain_transfer_cnt(uint32_t spi_port)
{
    //uint32_t saved_mask;
    //hal_nvic_save_and_set_interrupt_mask(&saved_mask);
...
ATTR_TEXT_IN_RAM_FOR_MASK_IRQ int32_t spi_get_sw_fifo_available_transfer_cnt(uint32_t spi_port)
{
    //uint32_t saved_mask;
    //hal_nvic_save_and_set_interrupt_mask(&saved_mask);
