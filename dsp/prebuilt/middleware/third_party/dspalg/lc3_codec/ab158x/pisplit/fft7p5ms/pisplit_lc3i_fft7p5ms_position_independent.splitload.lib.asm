...
00000000 <_init-0xa4>:
      ...
      50:	000020bb 00001b04 00002040 000023ac     . ......@ ...#..
...
00000170 <fix_fft_Init>:
     ...
     173:	ffba41                                    	l32r	a4, 5c (23ac <RotVector_40_32>)
...
00000304 <fix_fft6>:
     ...
     394:	0e94c69001e118d0c400884f05283f6f 	{ l32r	a6, 60 (6ed9eba1 <_end+0x6ed9c7cd>); movi	a8, 1; ae_addandsub32s	aed8, aed9, aed8, aed9; nop }
...
00000a80 <fix_fft5_8K>:
     ...
     acf:	0e95069b09e50cd0c400801f0c606b5f 	{ l32r	a5, 6c (b0000001 <_end+0xafffdc2d>); nop; ae_addandsub32s	aed0, aed3, aed0, aed3; nop }
     adf:	0e95468b39e154d0c40081070c20697f 	{ l32r	a7, 74 (9d839db0 <_end+0x9d8379dc>); ae_movda32	aed7, a5; ae_addandsub32s	aed0, aed1, aed1, aed0; nop }
     aef:	fd5e31                                    	l32r	a3, 68 (478dde64 <_end+0x478dba90>)
     af2:	248327392007675e                  	{ ae_movda32	aed4, a7; nop; ae_mulfp32x2ts	aed7, aed0, aed7 }
     afa:	0e9d434b29f134c0c0086c271c44596f 	{ l32r	a6, 70 (79bc3854 <_end+0x79bc1480>); ae_movda32	aed5, a3; ae_mulfp32x2ts	aed4, aed2, aed4; ae_add32s	aed2, aed2, aed3 }
     b0a:	fd5b81                                    	l32r	a8, 78 (d18053ce <_end+0xd1802ffa>)
...
00001518 <fix_fft40>:
    ...
    151b:	fad061                                    	l32r	a6, 5c (23ac <RotVector_40_32>)
...
00001562 <fix_fft40+0x4a>:
    ...
    15b7:	fab361                                    	l32r	a6, 84 (5a82799a <_end+0x5a8255c6>)
    15ba:	01a052                                    	movi	a5, 1
    15bd:	310766421c01c29e                  	{ l32r	a9, 88 (a57d8666 <_end+0xa57d6292>); ae_movda32	aed1, a6 }
