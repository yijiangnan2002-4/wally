...
00000000 <_init-0xa4>:
      ...
      10:	00001ff8 00000000 00002014 000020d0     ......... ... ..
      20:	0000205c 00000170 0000206f 00000b98     \ ..p...o ......
      30:	0000207f 00000d08 0000208f 00000e00     . ....... ......
      40:	0000209f 00001154 000020af 00001518     . ..T.... ......
      50:	000020bf 000018a0 00002040 000023b0     . ......@ ...#..
...
0000010c <_start>:
     ...
     10f:	ffc331                                    	l32r	a3, 1c (20d0 <printf_ptr>)
...
00000170 <fix_fft_Init>:
     ...
     173:	ffba41                                    	l32r	a4, 5c (23b0 <RotVector_40_32>)
     176:	59a432                                    	movi	a3, 0x459
     179:	1133c0                                    	slli	a3, a3, 4
...
00000304 <fix_fft6>:
     ...
     394:	0e94c69001e118d0c400884f05283f6f 	{ l32r	a6, 60 (6ed9eba1 <_end+0x6ed9c7c9>); movi	a8, 1; ae_addandsub32s	aed8, aed9, aed8, aed9; nop }
...
00000a80 <fix_fft5_8K>:
     ...
     acf:	0e95069b09e50cd0c400801f0c606b5f 	{ l32r	a5, 6c (b0000001 <_end+0xafffdc29>); nop; ae_addandsub32s	aed0, aed3, aed0, aed3; nop }
     adf:	0e95468b39e154d0c40081070c20697f 	{ l32r	a7, 74 (9d839db0 <_end+0x9d8379d8>); ae_movda32	aed7, a5; ae_addandsub32s	aed0, aed1, aed1, aed0; nop }
     aef:	fd5e31                                    	l32r	a3, 68 (478dde64 <_end+0x478dba8c>)
     af2:	248327392007675e                  	{ ae_movda32	aed4, a7; nop; ae_mulfp32x2ts	aed7, aed0, aed7 }
     afa:	0e9d434b29f134c0c0086c271c44596f 	{ l32r	a6, 70 (79bc3854 <_end+0x79bc147c>); ae_movda32	aed5, a3; ae_mulfp32x2ts	aed4, aed2, aed4; ae_add32s	aed2, aed2, aed3 }
     b0a:	fd5b81                                    	l32r	a8, 78 (d18053ce <_end+0xd1802ff6>)
...
00001518 <fix_fft40>:
    ...
    151b:	fad061                                    	l32r	a6, 5c (23b0 <RotVector_40_32>)
...
00001562 <fix_fft40+0x4a>:
    ...
    15b7:	fab361                                    	l32r	a6, 84 (5a82799a <_end+0x5a8255c2>)
    15ba:	01a052                                    	movi	a5, 1
    15bd:	310766421c01c29e                  	{ l32r	a9, 88 (a57d8666 <_end+0xa57d628e>); ae_movda32	aed1, a6 }
