...
#define MSBC_ENC_PIC_EXPORT_API_NUM 4
...
/***********************************************************************/
extern void msbc_enc_default_function_parameter(void);

void *msbc_enc_decoder_export_parameters[MSBC_ENC_PIC_EXPORT_API_NUM] = {
    msbc_enc_default_function_parameter,
    msbc_enc_default_function_parameter,
    msbc_enc_default_function_parameter,
    msbc_enc_default_function_parameter
};
...
void msbc_enc_default_function_parameter(void)
{
...
uint32_t msbc_enc_library_load(void *code_address, void *data_address, uint32_t *dram_pic_usage)
{
    ...
    load_info.library_callback = msbc_enc_load_library_callback;
    load_info.library = &pisplit_msbc_enc;
    load_info.dram_size = dram_pic_usage;
    preloader_pisplit_library_load_internal_port(&msbc_enc_load_lib_xSemaphore, &p_msbc_enc_pisplit_library_handle, &load_info);

    return 0;
}

uint32_t msbc_enc_library_unload(void)
{
    preloader_pisplit_library_unload_internal_port(p_msbc_enc_pisplit_library_handle, msbc_enc_decoder_export_parameters, MSBC_ENC_PIC_EXPORT_API_NUM, msbc_enc_default_function_parameter);
